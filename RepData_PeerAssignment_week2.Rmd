...
```{r summarisation, fig.height = 5, fig.width = 4 }
...
```
The average number of steps is `r mean_steps` and the median number of steps is `r median_steps`
...
```
The interval with the maximum number of steps is `r i_max_steps`
...
```
The average number of steps for the imputed data is `r mean_steps_i` and the median number of steps is `r median_steps_i`. 
